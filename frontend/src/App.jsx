...
const PerformancePage = lazy(() => import('./redesign/PerformancePage'))
  ...
  return (
    <>
      <header className="app-header">
          <NavLink to="/" onClick={closeNav} style={{ textDecoration: 'none', flexShrink: 0, display: 'flex', alignItems: 'center', marginTop: '-6px' }}>
            <h1 style={{ display: 'flex', alignItems: 'center', gap: 2, fontWeight: 900, fontSize: '2.1rem', letterSpacing: '0.08em', fontFamily: "'Inter Variable', 'Inter', -apple-system, BlinkMacSystemFont, sans-serif", margin: 0, cursor: 'pointer', direction: 'ltr' }}>
              <img src="/favicon.png?v=2" alt="V" style={{ height: '2.5rem', objectFit: 'contain', flexShrink: 0, filter: 'drop-shadow(0 2px 4px rgba(0, 210, 255, 0.6))' }} />
...
function AppLayout() {
  ...
  const PUBLIC_PATHS = ['/', '/about', '/contact', '/sign-up', '/performance']
    ...
    <div style={{
      ...
      <Link to="/" style={{ textDecoration: 'none' }}>
        <h1 style={{
          ...
          fontFamily: "'Inter Variable', 'Inter', -apple-system, BlinkMacSystemFont, sans-serif", margin: 0, direction: 'ltr',
        }}>
          <img src="/favicon.png?v=2" alt="V" style={{ height: '2.4rem', objectFit: 'contain', filter: 'drop-shadow(0 2px 6px rgba(0,210,255,0.7))' }} />
          <span className="title-shimmer" style={{ letterSpacing: '0.08em' }}>esign</span>
        </h1>
      </Link>
