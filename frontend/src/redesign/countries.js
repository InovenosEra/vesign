/* ISO country code → dial code, for the phone country-code picker.
 * Flag is derived from the ISO code (regional-indicator emoji), so we only store
 * {iso, name, dial}. Sorted by name. */
...
export const countryByIso = (iso) => COUNTRIES.find(c => c.iso === (iso || '').toUpperCase())
