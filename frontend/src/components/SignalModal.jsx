              ...
              <table style={{ fontSize: 12, borderCollapse: 'collapse', width: '100%', margin: 0, tableLayout: 'fixed' }}>
                <tbody>
                  {[
                    ...
                    [t('col.lowPrice'),        row.target_low_price  != null ? fmtPrice(row.target_low_price  / priceScale) : '—'],
                    [t('col.basePrice'),       row.target_mean_price != null ? fmtPrice(row.target_mean_price / priceScale) : '—'],
                    [t('col.highPrice'),       row.target_high_price != null ? fmtPrice(row.target_high_price / priceScale) : '—'],
